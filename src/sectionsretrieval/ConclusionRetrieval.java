 ...
 * and searches for the keyword "Conclusion" or "Conclusions" or "Future Work".
 ...
 */
public class ConclusionRetrieval {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String path = "../conclusions.txt";
        for (File file : files) {
            Scanner scan = new Scanner(file, "UTF-8");
            String contents = "";
            while (scan.hasNextLine()) {
                String myLine = scan.nextLine();
               if (myLine.endsWith("Conclusion") || myLine.endsWith("Conclusions") || myLine.endsWith("Future Work") || myLine.endsWith("Further Work")) {
